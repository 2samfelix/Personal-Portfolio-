  ...
  return (
    <section id="experience" className="bg-forest text-cream">
      <div className="mx-auto w-full max-w-6xl px-6 py-20 sm:py-28">
        ...
        <div className="flex flex-col gap-8 border-b border-cream/15 py-10 sm:flex-row sm:gap-12">
          <div className="w-full shrink-0 text-sm font-medium text-cream/60 sm:w-40">
            2025 — Present
          </div>
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-cream/60">Chicago, IL</p>
            <p className="mt-3 text-xs font-medium uppercase tracking-wide text-brass-light">
